...
var startUp = function() {
  ...
  if (window.location.protocol == "https:") {
    grab.js(["js/db.js", "js/frame.js", "js/jquery.js"], function() {
    ...
    grab.js("js/prefixfree.js", function() {
      console.log("Prefixfree");
      grab.css("//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css", function() {
        console.log("Font Awesome");
        $(".jb-toggle").addClass("fa-important").addClass("fa-bolt");
      });
      grab.js(["js/bootstrap.js"], function() {
        console.log("Bootstrap JS");
        grab.css(["css/bootstrap.css"], function() {
          console.log("Bootstrap CSS");
          if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
            $("body").addClass("mobile");
          } else console.log("Not on mobile.");
          grab.js(["js/bootbox.js"], function() {
            console.log("Bootbox");
            bootbox.setDefaults({
              locale: "en",
              backdrop: true,
    ...
    grab.js(["js/growl.js"], function() {
      console.log("Jotboard Growl");
      grab.js(["//togetherjs.com/togetherjs-min.js"], function() {
