...
!function(d, s, id) {
  ...
  function twitter() {
    var wen = 400;
    var hen = 340;
    return window.open('//twitter.com/intent/tweet?hashtags=Jotboard%2C&related=Jotboard,Lowles98&text=...&url=' + window.location.href, '_popup', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=' + 400 + ', height=' + hen + ', top=' + (screen.height / 2) - (hen / 2) + ', left=' + (screen.width / 2) - (wen / 2));
  }
